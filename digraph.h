...
public:
  ...
  // return all neighbours of v as a vector
  unordered_set<int> all_neighbours(int v);

  // return a random neighbour of v
  int random_nbr(int v, unordered_map<int,int> visited);
  ...
  // return a vector with all edges 
  vector<PII> edges();
